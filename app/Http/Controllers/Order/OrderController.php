...
class OrderController extends Controller
{
    ...
    private function markOrderAsComplete($project, Order $order)
    {
        ...
        $order->expired_at = $order->subscription->subscription_type == 'MONTHLY' ? Carbon::now()->subMonth(-1) : ($order->subscription->subscription_type == 'ANNUALLY' ? Carbon::now()->subYear(-1) : Carbon::now()->subDay(-1));
